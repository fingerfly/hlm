...
function makeSummaryCell(key, value) {
...
export function renderResultInto(container, result, versionLabel) {
  ...
  summary.append(
    makeSummaryCell("总番数", vm.totalFan),
    makeSummaryCell("起和门槛", vm.minWinningFan),
    makeSummaryCell("和型", vm.winPatternText),
    makeSummaryCell("版本", versionLabel)
  );
